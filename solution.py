...
class SOLUTION:
    ...
    def Generate_Body(self):
        ...
        pyrosim.Send_Joint( name = "Torso_LMLeg1" , parent= "Torso" , child = "LMLeg1" , type = "revolute", position = [0,0.2,1], jointAxis="1 0 0")
        ...
        pyrosim.Send_Joint( name = "Torso_RMLeg1" , parent= "Torso" , child = "RMLeg1" , type = "revolute", position = [0,-.2,1], jointAxis="1 0 0")
