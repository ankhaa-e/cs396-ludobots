...
def Generate_Body():
    ...
    pyrosim.Send_Joint( name = "Torso_Abdomen" , parent= "Torso" , child = "Abdomen" , type = "revolute", position = [.375,0,1],jointAxis="0 0 1")
    pyrosim.Send_Cube(name="Abdomen", pos=[.375,0,0] , size=[.75,.4,.3])
    pyrosim.Send_Joint( name = "Torso_Head" , parent= "Torso" , child = "Head" , type = "revolute", position = [-.375,0,1],jointAxis="0 0 1")
    ...
    pyrosim.Send_Joint( name = "Abdomen_LBLeg1" , parent= "Abdomen" , child = "LBLeg1" , type = "revolute", position = [.65,0.2,0], jointAxis="1 0 -1")
    #TO DO TRY JOINT AXIS 1 0 1
    pyrosim.Send_Cube(name="LBLeg1", pos=[0,0.375,0] , size=[.2*length,width*.75,.2*height])
    pyrosim.Send_Joint( name = "LBLeg1_LBLeg2" , parent= "LBLeg1" , child = "LBLeg2" , type = "revolute", position = [0,.75,0],jointAxis="1 0 0")
    pyrosim.Send_Cube(name="LBLeg2", pos=[0,0,-.375] , size=[.2*length,.2*width,height*.75])

    pyrosim.Send_Joint( name = "Abdomen_RBLeg1" , parent= "Abdomen" , child = "RBLeg1" , type = "revolute", position = [.65,-.2,0], jointAxis="1 0 -1")
    pyrosim.Send_Cube(name="RBLeg1", pos=[0,-.375,0] , size=[.2*length,width*.75,.2*height])
    pyrosim.Send_Joint( name = "RBLeg1_RBLeg2" , parent= "RBLeg1" , child = "RBLeg2" , type = "revolute", position = [0,-.75,0],jointAxis="1 0 0")
    pyrosim.Send_Cube(name="RBLeg2", pos=[0,0,-.375] , size=[.2*length,.2*width,height*.75])

    pyrosim.Send_Joint( name = "Head_LFLeg1" , parent= "Head" , child = "LFLeg1" , type = "revolute", position = [-.65,0.2,0], jointAxis="1 0 1")
    pyrosim.Send_Cube(name="LFLeg1", pos=[0,0.375,0] , size=[.2*length,width*.75,.2*height])
    pyrosim.Send_Joint( name = "LFLeg1_LFLeg2" , parent= "LFLeg1" , child = "LFLeg2" , type = "revolute", position = [0,.75,0],jointAxis="1 0 0")
    pyrosim.Send_Cube(name="LFLeg2", pos=[0,0,-.375] , size=[.2*length,.2*width,height*.75])

    pyrosim.Send_Joint( name = "Head_RFLeg1" , parent= "Head" , child = "RFLeg1" , type = "revolute", position = [-.65,-.2,0], jointAxis="1 0 1")
    pyrosim.Send_Cube(name="RFLeg1", pos=[0,-.375,0] , size=[.2*length,width*.75,.2*height])
    pyrosim.Send_Joint( name = "RFLeg1_RFLeg2" , parent= "RFLeg1" , child = "RFLeg2" , type = "revolute", position = [0,-.75,0],jointAxis="1 0 0")
...
def Generate_Brain():
    ...
    sensors = ["LMLeg2","RMLeg2","RFLeg2","LFLeg2","LBLeg2","RBLeg2"]
    joints = ["Torso_Abdomen","Torso_Head","Torso_LMLeg1","LMLeg1_LMLeg2","Torso_RMLeg1","RMLeg1_RMLeg2",
